...
class BasePanel(ScreenPanel):
    def __init__(self, screen, title, back=True, action_bar=False, printer_name=True):
        ...
        self.control['macro_shortcut'].connect("clicked", self.menu_item_clicked, "gcode_macros", {            "name": "Macros",
            "panel": "gcode_macros"
        })
