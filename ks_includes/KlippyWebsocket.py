...
class KlippyWebsocket(threading.Thread):
    ...
    def on_message(self, *args):
        ...
        if "id" in response and response['id'] in self.callback_table:
            ...
            GLib.idle_add(self.callback_table[response['id']][0], *args, priority=GLib.PRIORITY_DEFAULT)
        ...
        if "method" in response and "on_message" in self._callback:
            ...
            GLib.idle_add(self._callback['on_message'], *args, priority=GLib.PRIORITY_DEFAULT)
        return
    ...
    def on_open(self, *args):
        ...
        if "on_connect" in self._callback:
            GLib.idle_add(self._callback['on_connect'], priority=GLib.PRIORITY_DEFAULT)
