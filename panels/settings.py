...
class SettingsPanel(ScreenPanel):
    def __init__(self, screen, title):
        ...
        self.labels['settings_menu'] = self._gtk.ScrolledWindow(True)
        ...
        self.labels['lang_menu'] = self._gtk.ScrolledWindow(True)
        ...
        self.labels['printers_menu'] = self._gtk.ScrolledWindow(True)
